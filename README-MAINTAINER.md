...
Determine the upstream version (like `2.0.0`) and eventually update the
...
and fix them; assign them to a milestone (like `2.0.0`).
...
- add a new entry like _\* v2.0.0_
...
- `npm dist-tag add @micro-os-plus/devices-qemu-riscv@2.0.0 latest`
- `npm dist-tag ls @micro-os-plus/devices-qemu-riscv`
